...
export default function Header() {
  ...
  return (
    <header style={{position:"static",paddingTop:"2.5rem"}}>
      ...
      <nav className='navbar'>      <div className='block pr-10' >
      <img src={'https://flagemoji.net/img/flags/palestine-flag.png'} alt={"palestine-flag"} width={"50px"}  height={"auto"} style={{padding:'0px 10px'}} loading="lazy" />
